...
def run_solver(filepath, flag):
    ...
    try:
        ...
        # --- PARSING (EXTRACTION DES DONNÉES) ---
...
def main():
    ...
    # En-têtes CSV (On ne met PAS 'tour' ici pour respecter la consigne)
    ...
    # En-tête du terminal (plus large pour accueillir le chemin)
    ...
    print("-" * 100)
    print(f"Terminé ! Résultats (propres) sauvegardés dans {OUTPUT_CSV}")
